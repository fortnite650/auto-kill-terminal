...
4. **Run the installer**  
   - On Windows, double-click the `.exe` file and follow the setup wizard instructions.  
   - On macOS, open the `.dmg` file and move the app to your Applications folder.  
   - On Linux, extract the archive and follow any included README files for setup.

5. **Open Visual Studio Code or GitHub Codespaces**  
   Launch the environment where you want to use auto-kill-terminal.

6. **Run the install script if needed**  
...
7. **Restart VS Code or Codespaces**  
   This ensures the changes take effect.

---

## ⚙️ How to Use auto-kill-terminal
...
## 👨‍💻 Using Templates and Development Containers
